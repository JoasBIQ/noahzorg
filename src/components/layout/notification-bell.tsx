...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[min(20rem,calc(100vw-2rem))] max-h-[500px] overflow-y-auto bg-white rounded-xl shadow-xl border border-gray-100 z-50">
          {/* Header */}
